...
Importantly, you can use an object in place of the function name, and that will cause the ``__call__`` method to be executed. So if I had the following::
...
Then I could recreate the example from above with::
...
Of course, adding 1 to the provided argument doesn't really do much to progress us towards having a functioning chatroom. So, how can we repurpose this?
