...
Now you should make sure you get the most recent released version, which is currently v3.2.0

* Type ``git checkout v3.2.0`` and press Enter
* Next, type ``git merge tags/v3.2.0`` and press Enter.

You should now have v3.2.0 of Mysterious Messenger. In the future, you can use ``git checkout v3.2.0`` and ``git merge tags/v3.2.0`` with future version numbers to update to the latest version of Mysterious Messenger.
