...
where `ja` is the variable of the character whom the player is calling or who is calling the player (see [character_definitions.rpy](https://github.com/shawna-p/mysterious-messenger/blob/v2.2.1-docs/game/character_definitions.rpy "character_definitions.rpy")) for a list of the existing characters).
