...
screen menu_header(title, return_action=NullAction,
    ...
    hbox:
        style_prefix "hg_hp"
        add my_menu_clock xanchor 0.0 yalign 0.0 xpos 8
        null width 55
        fixed:
        ...
        vbox:
            ...
            hbox:
                textbutton _("Confirm") action If(persistent.HG>=num_hg, yes_action,
                    CConfirm(_("You don't have enough hourglasses.")))
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Indicate correct answer ({})").format(_("ON") if persistent.show_email_answers else _("OFF")):
                    style_prefix 'other_settings_end'
                    align (0.5, 0.5)
                    xysize (270, 80)
