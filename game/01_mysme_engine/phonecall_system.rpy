    ...
    def MMHangupCall(story=False, incoming=False):
        ...
        if story:
            return If(observing or current_timeline_item.currently_expired,
                ...
                CConfirm(_("Do you really want to hang up this call? Please note that you cannot participate once you leave. If you want to participate in this call again, you will need to buy it back."),
                [Hide('phone_say'),
                    Jump('exit_item_early')]
                ))
        else:
            return CConfirm(_("Do you really want to end this phone call? You may not be able to have this conversation again if you hang up."),
