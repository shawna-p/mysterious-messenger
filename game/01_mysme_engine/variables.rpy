    ...
    def check_version(test=False, force=False):
        ...
        try:
            ...
            if force:
                renpy.show_screen("confirm",
                    message=_("Could not check for updates. Make sure you're connected to the internet before trying again."),
        ...
        try:
            ...
            if version_tag == store.config.version:
                ...
                if force:
                    renpy.show_screen("confirm",
                        message=(_("Your program is already up-to-date.")),
                        yes_action=Hide('confirm'))
                if not test:
                    return
...
default 4 generic_storycall = StoryCall(_('Story Call'), 'generic_storycall', '00:00', None)
