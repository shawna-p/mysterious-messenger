...
define bubble_list = [ ['Bubble/', '-Bubble.webp'], ['Bubble/', '-Glow.webp'],
                        ...
                        ['Bubble/Special/', '_round_l.webp'],
                        ['Bubble/Special/', '_round_m.webp'],
                        ['Bubble/Special/', '_round_s.webp'],
                        ['Bubble/Special/', '_sigh_l.webp'],
                        ['Bubble/Special/', '_sigh_m.webp'],
                        ['Bubble/Special/', '_sigh_s.webp'],
                        ['Bubble/Special/', '_square_l.webp'],
                        ['Bubble/Special/', '_square_m.webp'],
                        ['Bubble/Special/', '_square_s.webp'],
                        ['Bubble/Special/', '_spike_l.webp'],
                        ['Bubble/Special/', '_spike_m.webp'],
                        ['Bubble/Special/', '_spike_s.webp'],
                        ['Bubble/Special/', '_square2_l.webp'],
                        ['Bubble/Special/', '_square2_m.webp'],
                        ['Bubble/Special/', '_square2_s.webp'],
                        ['Bubble/Special/', '_round2_l.webp'],
                        ['Bubble/Special/', '_round2_m.webp'],
                        ['Bubble/Special/', '_round2_s.webp'],
                        ['Bubble/Special/', '_flower_s.webp'],
                        ['Bubble/Special/', '_flower_m.webp'],
                        ['Bubble/Special/', '_flower_l.webp'],
                        ['Bubble/Special/', '_glow2.webp'] ]