...
Included in the repository is a file called Script Generator.xlsx. The spreadsheet file has an instruction tab and a several templates to facilitate turning dialogue into readable code for the program. Once you've filled out the template sheet correctly, you can simply copy-paste the code into the program and add in any outstanding features, such as choice menus or background music. Linked at the bottom of this page is also an extensive User Guide to help answer any questions or problems you run into, and guide you through the basics of using the program.
